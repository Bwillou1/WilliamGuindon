...
| Fichier | Rôle |
|---|---|
| `index.html` | Biographie complète + données structurées Schema.org (Person, ProfilePage, FAQPage) |
| `llms.txt` | Faits vérifiables au format lisible par les agents IA |
